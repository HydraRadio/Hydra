...
def get_config():
    ...
    """
    description = (
        "Example Gibbs sampling of the joint posterior of several analysis "
    ...
    parser.add_argument(
        ...
        action="store_true",
        required=False,
        dest="save_timing_info",
        help="Save timing info.",
    )
    parser.add_argument(
        "--plotting",
        action="store_true",
    ...
    parser.add_argument(
        "--ptsrc-amp-prior-level",
        type=float,
        action="store",
        default=0.1,
        required=False,
        dest="ptsrc_amp_prior_level",
    ...
    parser.add_argument(
        "--sim-diffuse-sky-model",
        type=str,
        action="store",
        default="none",
        required=False,
        dest="sim_diffuse_sky_model",
    ...
    parser.add_argument(
        "--gain-prior-zero-mode-std",
        type=float,
        action="store",
        default=None,
        required=False,
        dest="gain_prior_zero_mode_std",
        help="Separately specify the gain prior standard deviaiton for the zero mode.",
    )
    parser.add_argument(
        "--gain-only-positive-modes",
        type=bool,
        action="store",
        default=True,
        required=False,
        dest="gain_only_positive_modes",
    ...
    parser.add_argument(
        ...
        default=10,
        required=False,
        dest="region_nregions",
        help="No. of regions to break up a diffuse map into.",
    )
    parser.add_argument(
        "--region-smoothing-fwhm",
        type=float,
        action="store",
        default=None,
        required=False,
        dest="region_smoothing_fwhm",
    ...
    parser.add_argument(
        "--region-amp-prior-level",
        type=float,
        action="store",
        default=0.1,
        required=False,
        dest="region_amp_prior_level",
